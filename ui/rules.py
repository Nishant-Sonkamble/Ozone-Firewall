...
class RulesPage(QWidget):
    ...
    def __init__(self):
        ...
        self.allow_btn.clicked.connect(self.allow_rule)
        self.block_btn.clicked.connect(self.block_rule)
    ...
    def populate_table(self):
        ...
        for row, rule in enumerate(rules):
            ...
            if rule["action"] == "BLOCK":
                ...
                action_item.setBackground(Qt.darkGreen)
    ...
    def allow_rule(self):
     ...
     success, out, err = allow_application(rule["path"])
    ...
    def block_rule(self):
     ...
     success, out, err = block_application(rule["path"])
