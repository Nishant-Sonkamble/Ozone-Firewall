...
class VirusTotalPage(QWidget):
    ...
    def build_ui(self):
        ...
        self.empty_label = QLabel(
            "🔍 No VirusTotal scans yet.\n"
            "Files you scan with VirusTotal will appear here."
        )
    ...
    def filter_history(self):
        ...
        for row in range(self.history_table.rowCount()):
            ...
            process = self.history_table.item(
                row, 0
            ).text().lower()

            status = self.history_table.item(
                row, 1
            ).text().lower()
    ...
    def show_scan_details(self, record):
        ...
        harmless_votes = votes.get(
            "harmless",
            0
        )

        malicious_votes = votes.get(
            "malicious",
            0
        )
    ...
    def populate_table(self):
        ...
        # Hide empty-state message when scans exist
        ...
        for record in self.scans:
            ...
            detection_item = NumericTableWidgetItem(
                detection
            )
            ...
            detection_item.setTextAlignment(
                Qt.AlignCenter
            )
